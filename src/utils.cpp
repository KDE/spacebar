...
bool Utils::isPremiumNumber(const PhoneNumberSet &phoneNumberList) const
{
...
PhoneNumberSet Utils::phoneNumberList(const QStringList &phoneNumbers) const
{
    PhoneNumberSet list;
    ranges::transform(phoneNumbers, std::inserter(list, list.begin()), [](const auto &phoneNumber) {
...
QString Utils::phoneNumberListToString(const PhoneNumberSet &phoneNumberList) const
{
