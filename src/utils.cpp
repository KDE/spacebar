...
bool Utils::isPremiumNumber(const PhoneNumber &number) const
{
    ...
    auto numberString = number.toNational();
...
QString Utils::phoneNumberToInternationalString(const PhoneNumber &number) const
{
