...
private:
    ...
    QString lookupValString(const QByteArray &data, int &pos, const QVector<QStringView> &list);
    ...
    QByteArray encodeValueFromList(const QString &value, const QVector<QStringView> &list);
    ...
    const QVector<QStringView> messageTypes = {
        u"m-send-req",
        u"m-send-conf",
        u"m-notification-ind",
        u"m-notifyresp-ind",
        u"m-retrieve-conf",
        u"m-acknowledge-ind",
        u"m-delivery-ind",
        ...
        u"m-mbox-view-conf",
        u"m-mbox-upload-req",
        u"m-mbox-upload-conf",
        u"m-mbox-delete-req",
        u"m-mbox-delete-conf",
        u"m-mbox-descr",
        u"m-delete-req",
        u"m-delete-conf",
        u"m-cancel-req",
    ...
    const QVector<QStringView> contentTypes = {
        u"*/*",
        u"text/*",
        u"text/html",
        u"text/plain",
    ...
    const QVector<QStringView> statusValues = {
        u"expired",
        u"retrieved",
        u"rejected",
        u"deferred",
    ...
    const QVector<field_map> header_fields = {
    ...
    const QVector<field_map> param_fields = {
        { 0x01, u"q",                    u"qValue" },
        { 0x02, u"charset",              u"textString" },
        { 0x03, u"level",                u"versionValue" },
        { 0x04, u"type",                 u"integerValue" },
        { 0x05, u"name",                 u"textString" },
        { 0x06, u"filename",             u"encodedStringValue" },
        { 0x07, u"differences",          u"fieldName" },
        { 0x08, u"padding",              u"shortInteger" },
        { 0x09, u"typeSpec",             u"textString" },
        { 0x0A, u"start",                u"textString" },
        { 0x0B, u"startInfo",            u"textString" },
        { 0x0C, u"comment",              u"textString" },
        { 0x0D, u"domain",               u"textString" },
        { 0x0E, u"maxAge",               u"longInteger" },
        { 0x0F, u"path",                 u"textString" },
        { 0x10, u"secure",               u"" },
        { 0x11, u"sec",                  u"shortInteger" },
        { 0x12, u"mac",                  u"textValue" },
        { 0x13, u"creationDate",         u"longInteger" },
        { 0x14, u"modificationDate",     u"longInteger" },
        { 0x15, u"readDate",             u"longInteger" },
        { 0x16, u"size",                 u"integerValue" },
        { 0x17, u"nameVal",              u"textValue" },
        { 0x18, u"filenameVal",          u"textValue" },
        { 0x19, u"startMulti",           u"textValue" },
        { 0x1A, u"startInfoMulti",       u"textValue" },
        { 0x1B, u"commentVal",           u"textValue" },
        { 0x1C, u"domainVal",            u"textValue" },
